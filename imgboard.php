...
<link rel="stylesheet" type="text/css" href="' . DATA_SERVER . CSSFILE . '" title="Standard Saguaro" />
<link rel="alternate stylesheet" type="text/css" media="screen" title="' . STYLESHEET_2 . '" href="'  . DATA_SERVER . CSSFILE2 . '" />
<link rel="alternate stylesheet" type="text/css" media="screen" title="' . STYLESHEET_3 . '" href="' . DATA_SERVER . CSSFILE3 . '" />
<link rel="alternate stylesheet" type="text/css" media="screen" title="' . STYLESHEET_4 . '" href="' . DATA_SERVER . CSSFILE4 . '" />
...
<form action="' . PHP_SELF_ABS . '" method="post" name="contrib" enctype="multipart/form-data">
...
<input type="hidden" name="MAX_FILE_SIZE" value="' . $maxbyte . '" />';
    ...
    if ( $resno ) {
		$dat .= "[<a href=\"" . PHP_SELF2_ABS . "\">" . S_RETURN . "</a>] [<a href=\""  . $no . PHP_EXT . "#bottom\"/>Bottom</a>]\n<hr />";
	}
