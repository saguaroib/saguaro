            ...
            if (!$mysql_good) {
                ...
                if ($has_db) {
                    ...
                    $tables = [
                        ...
                        SQLLOG => "`no` int(11) NOT NULL AUTO_INCREMENT,  `now` text,  `name` text,  `email` text,  `sub` text,  `com` text,  `host` text,  `pwd` text,  `media` text,  `time` int(11) DEFAULT NULL,  `sticky` int(11) DEFAULT NULL,  `permasage` int(11) DEFAULT NULL,  `locked` int(11) DEFAULT NULL,  `last` int(11) DEFAULT NULL,  `modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,  `resto` int(11) DEFAULT NULL,  `board` varchar(55),  `capcode` varchar(50) NOT NULL,  `id` varchar(50) NOT NULL,  `country` varchar(4) NOT NULL,  `last_modified` int(25) NOT NULL,  `tripcode` varchar(100) NOT NULL, PRIMARY KEY (`no`,`board`)",                     
