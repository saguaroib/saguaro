<?php
/*
        ===  DEPRECEATED, SPLIT UP INTO MULTIPLE FILES IN _core/admin/bans/* ===
        
        This handles filing bans, ban requests and the ban screen.
        Pretty much everything ban related.
...
class Banish {
    ...
    function isBanned($ip, $redirect = 0) {
        ...
        $exists   = $mysql->result("SELECT COUNT(*) FROM " . SQLBANLOG . " WHERE host='$ip' AND (board='" . BOARD_DIR . "' or global=1)");
    ...
    */
	...
	private function banScreen($host) {
