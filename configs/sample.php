...
define(RAWSALT, 'CHANGEME'); //Make this string only consist of uppercase/lowercase letters, and numbers. It must be random and long. 
//This is the salt string used to generate secure tripcodes. Example: AASGewgw34ESRVfJ65hweragw43hqerZD
define(SALTFILE, 'CHANGEME'); //Path to the salt file (with the file name at the end) that will be generated by the script. Example: /path/to/file/salt.file
