...
define(CSSFILE2, 'burichan.css');						//location of the second stylesheet.
define(STYLESHEET_2, 'Burichan');						//Name of the second stylesheet.
define(CSSFILE3, 'kusaba.css');						//location of the third stylesheet.
define(STYLESHEET_3, 'Kusaba');						//Name of the third stylesheet.
define(CSSFILE4, 'monotone.css');						//location of the fourth stylesheet.
